...
def main(_):
  ...
  print('\ngraph, bottleneck_tensor, resized_image_tensor:',graph, bottleneck_tensor, resized_image_tensor)
  ...
  with tf.Session(graph=graph) as sess:
    ...
    print('\njpeg_data_tensor, decoded_image_tensor:', jpeg_data_tensor, decoded_image_tensor)
